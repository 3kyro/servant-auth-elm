...
var $author$project$App$init = function (cookies) {
	return _Utils_Tuple2(
		$author$project$App$initModel(cookies),
...
var $author$project$Http$XSRF$header = F2(
	function (headerName, cookie) {
		return A2(
			$elm$http$Http$header,
			headerName,
			A2($elm$core$Maybe$withDefault, '', cookie));
	});
...
var $author$project$Http$XSRF$authRequest = function (_v0) {
	var method = _v0.method;
	var headers = _v0.headers;
	var url = _v0.url;
	var body = _v0.body;
	var expect = _v0.expect;
	var xsrfHeaderName = _v0.xsrfHeaderName;
	var xsrfToken = _v0.xsrfToken;
	...
	return $elm$http$Http$request(
		{
			...
			headers: A2(
				$elm$core$List$cons,
				A2($author$project$Http$XSRF$header, xsrfHeaderName, xsrfToken),
				headers),
			method: method,
			timeout: timeout,
			tracker: tracker,
...
var $author$project$Http$XSRF$authGet = function (_v0) {
	var url = _v0.url;
	var expect = _v0.expect;
	var xsrfHeaderName = _v0.xsrfHeaderName;
	var xsrfToken = _v0.xsrfToken;
	return $author$project$Http$XSRF$authRequest(
		{body: $elm$http$Http$emptyBody, expect: expect, headers: _List_Nil, method: 'GET', timeout: $elm$core$Maybe$Nothing, tracker: $elm$core$Maybe$Nothing, url: url, xsrfHeaderName: xsrfHeaderName, xsrfToken: xsrfToken});
};
...
var $author$project$Http$XSRF$token = F2(
	function (name, str) {
		var cookies = A2($elm$core$String$split, ';', str);
		var filtered = A2(
		...
		return A2(
			$elm$core$Maybe$map,
			$elm$core$String$dropLeft(11),
			$elm$core$List$head(filtered));
	});
var $author$project$App$getEmailRequest = function (model) {
	return $author$project$Http$XSRF$authGet(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$App$ReceivedEmail, $elm$json$Json$Decode$string),
...
var $author$project$App$encodeLogin = F2(
...
var $author$project$App$login = F2(
	function (username, password) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					A2($author$project$App$encodeLogin, username, password)),
				expect: $elm$http$Http$expectWhatever($author$project$App$LoginResponse),
...
var $author$project$App$ChangePassword = function (a) {
...
var $author$project$App$showPassword = function (model) {
	return A2(
		...
		_List_Nil,
		{
			...
			label: A2(
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('Show password')),
			onChange: $author$project$App$ShowPassword
		});
};
